...
export default function MarketIntelligence() {
  return (
    <section id="intelligence" className="py-12 border-b border-slate-200/80 dark:border-white/[0.06]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white dark:bg-[#0C1017] border border-slate-200 dark:border-white/[0.08] rounded-2xl p-5 shadow-xs dark:shadow-xl flex flex-col justify-between">
            <div>
              ...
              {/* Visual meter bar */}
              <div className="mt-4">
                <div className="w-full bg-slate-100 dark:bg-[#07090E] h-2 rounded-full overflow-hidden flex">
                ...
                <div className="flex justify-between text-[10px] font-mono text-slate-400 dark:text-slate-500 mt-1.5">
                  ...
                  <span className="text-blue-600 dark:text-blue-400 font-bold">18.4 Current</span>
        ...
        <div className="bg-white dark:bg-[#0C1017] border border-slate-200 dark:border-white/[0.08] rounded-2xl p-6 sm:p-7 shadow-xs dark:shadow-xl relative overflow-hidden">
