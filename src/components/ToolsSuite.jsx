...
export default function ToolsSuite({ rates = DEFAULT_RATES, cryptoList = [] }) {
  ...
  return (
    <section id="tools" className="py-12 border-b border-white/[0.06]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 gap-4">
          ...
          {/* Tool Tab Switcher */}
          <div className="flex items-center gap-1.5 p-1 rounded-2xl bg-[#0C1017] border border-white/[0.08] self-start md:self-end">
            <button
        ...
        {activeTool === 'forex' && (
          <div className="bg-[#0C1017] border border-white/[0.08] rounded-3xl p-6 sm:p-8 shadow-2xl animate-in fade-in duration-200">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-center">
              
              <div className="lg:col-span-4 bg-[#07090E] border border-white/[0.08] rounded-2xl p-4">
                ...
                <input
                  ...
                  className="w-full bg-transparent text-3xl font-black text-white font-mono tabular-nums focus:outline-none"
                  placeholder="100.00"
                />
              </div>

              <div className="lg:col-span-3 bg-[#07090E] border border-white/[0.08] rounded-2xl p-4">
                <label className="block text-[11px] font-bold text-slate-400 uppercase font-mono mb-1">
                  From Currency
                </label>
                <select
                ...
                >
                  {CURRENCIES.map(c => (
                    <option key={c.code} value={c.code} className="bg-[#0C1017] text-white">
              ...
              <div className="lg:col-span-2 flex justify-center py-1 lg:py-0">
                <button
                  ...
                  className="w-12 h-12 rounded-full bg-blue-600 hover:bg-blue-500 text-white flex items-center justify-center cursor-pointer transition-transform hover:rotate-180"
                >
            ...
            {/* Result Display */}
            <div className="mt-6 p-6 rounded-2xl bg-[#07090E] border border-white/[0.08] flex flex-col sm:flex-row sm:items-baseline justify-between gap-4">
              <div>
                <div className="text-[11px] font-bold text-slate-400 uppercase font-mono mb-1">
                  Exchange Value Output
                </div>
                <div className="text-3xl sm:text-5xl font-black text-white font-mono tabular-nums">
                  {getCurrencyInfo(forexTarget).symbol} {forexConverted.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 4 })} <span className="text-emerald-400 text-xl font-bold">{forexTarget}</span>
                </div>
              ...
              <button
                ...
                className="px-4 py-2.5 rounded-xl bg-white/[0.06] hover:bg-white/[0.1] text-white text-xs font-semibold flex items-center gap-2 border border-white/[0.08] cursor-pointer"
              >
          ...
          <div className="bg-[#0C1017] border border-white/[0.08] rounded-3xl p-6 sm:p-8 shadow-2xl animate-in fade-in duration-200">
              ...
              <div className="lg:col-span-4 bg-[#07090E] border border-white/[0.08] rounded-2xl p-4">
                ...
                >
                  {(cryptoList.length > 0 ? cryptoList : [
                    ...
                    <option key={c.id} value={c.id} className="bg-[#0C1017] text-white">
            ...
            <div className="mt-6 p-6 rounded-2xl bg-[#07090E] border border-white/[0.08] flex flex-col sm:flex-row sm:items-baseline justify-between gap-4">
              <div>
                ...
                <div className="text-3xl sm:text-5xl font-black text-emerald-400 font-mono tabular-nums">
                  {fiatObj.symbol} {cryptoConvertedFiat.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })} <span className="text-white text-xl font-bold">{cryptoFiat}</span>
                </div>
                <div className="text-xs text-slate-400 font-mono mt-1 tabular-nums">
        ...
        {activeTool === 'risk' && (
          <div className="bg-[#0C1017] border border-white/[0.08] rounded-3xl p-6 sm:p-8 shadow-2xl animate-in fade-in duration-200">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div className="bg-[#07090E] border border-white/[0.08] rounded-2xl p-4">
                <label className="block text-[11px] font-bold text-slate-400 uppercase font-mono mb-1">
                  Account Balance (USD)
                </label>
                <div className="flex items-center">
                  <span className="text-xl font-bold text-slate-500 mr-1.5 font-mono">$</span>
                  <input
                    type="number"
                    value={accountBalance}
                    onChange={(e) => setAccountBalance(e.target.value)}
                    className="w-full bg-transparent text-2xl font-black text-white font-mono tabular-nums focus:outline-none"
                    placeholder="10000"
                  />
                </div>
              </div>
              ...
              <div className="bg-[#07090E] border border-white/[0.08] rounded-2xl p-4">
                ...
                <div className="flex items-center">
                  <input
                    ...
                    placeholder="1.0"
                  />
                  <span className="text-xl font-bold text-slate-500 ml-1.5 font-mono">%</span>
                </div>
              </div>
              ...
              <div className="bg-[#07090E] border border-white/[0.08] rounded-2xl p-4">
                ...
                <select
                  ...
                  className="w-full bg-transparent text-white font-bold text-base focus:outline-none cursor-pointer mt-1"
                >
                  <option value="EUR/USD" className="bg-[#0C1017]">EUR/USD</option>
                  <option value="GBP/USD" className="bg-[#0C1017]">GBP/USD</option>
                  <option value="USD/JPY" className="bg-[#0C1017]">USD/JPY</option>
                  <option value="USD/CHF" className="bg-[#0C1017]">USD/CHF</option>
                  <option value="AUD/USD" className="bg-[#0C1017]">AUD/USD</option>
                  <option value="USD/CAD" className="bg-[#0C1017]">USD/CAD</option>
                </select>
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-6">
              ...
              <div className="p-5 rounded-2xl bg-[#07090E] border border-white/[0.08]">
                <div className="text-[11px] font-mono text-slate-400 uppercase">Capital at Risk</div>
                <div className="text-3xl font-black text-rose-400 font-mono tabular-nums mt-1">
              ...
              <div className="p-5 rounded-2xl bg-[#07090E] border border-white/[0.08]">
                <div className="text-[11px] font-mono text-slate-400 uppercase">Recommended Position Size</div>
                <div className="text-3xl font-black text-emerald-400 font-mono tabular-nums mt-1">
                  {riskCalculations.lotSize} <span className="text-base text-slate-300 font-normal">Lots</span>
                </div>
                <div className="text-[10px] text-slate-500 font-mono mt-1">
              ...
              <div className="p-5 rounded-2xl bg-[#07090E] border border-white/[0.08]">
                <div className="text-[11px] font-mono text-slate-400 uppercase">Calculated Pip Value</div>
                <div className="text-3xl font-black text-blue-400 font-mono tabular-nums mt-1">
                  ${riskCalculations.pipValueForPosition} <span className="text-base text-slate-300 font-normal">/ pip</span>
                </div>
                <div className="text-[10px] text-slate-500 font-mono mt-1">
